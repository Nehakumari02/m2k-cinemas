...
import { removeFromCart, updateCartQuantity, getMemberships, loadUser } from '../../../store/actions';
      ...
      <Container className={classes.container}>
        <div className={classes.emptyCart}>
          ...
          <Typography color="textSecondary" paragraph>
            Looks like you haven't added any merchandise yet.
          </Typography>
          <Button
            component={Link}
            to="/shop"
          ...
          <Paper className={classes.summaryPaper} elevation={0}>
            ...
            {pricing.membershipName && (
              <Typography variant="caption" style={{ color: '#b72429', fontWeight: 700, display: 'block', marginBottom: 12 }}>
                {pricing.membershipName} member — {pricing.membershipDiscountPercent}% off shop
              </Typography>
            )}
            ...
            <Box display="flex" justifyContent="space-between" mb={2}>
              ...
              <Typography style={{ fontWeight: 600, color: '#22c55e' }}>
                FREE
              </Typography>
            </Box>
